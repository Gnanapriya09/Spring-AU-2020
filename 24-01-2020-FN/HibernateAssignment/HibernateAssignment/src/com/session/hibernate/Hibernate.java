...
public class Hibernate {
	public static void main(String[] args) {
		...
		addr.setPincode("625016");
		addr.setStreet("RS-Street");

		Address addr2 = new Address();
		addr.setPincode("625005");
		addr.setStreet("Street2");
		User user1 = new User(1, "Priya", "gp@gmail.com", 2198891, addr);
		User user2 = new User(2, "kayal", "kayal@gmail.com", 89298298, addr);
